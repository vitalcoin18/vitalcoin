...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "VitalCoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "VitalCoin is downloading blocks...");
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "VitalCoin is downloading blocks...");
